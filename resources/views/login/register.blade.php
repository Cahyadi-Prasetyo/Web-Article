...
<head>
    ...
    <style>
        /* Tetap pertahankan animasi fade-in */
        @keyframes fadeIn {
            from {
                opacity: 0;
    ...
    <main class="flex items-center justify-center min-h-[85vh] px-4 fade-in">
        <div class="bg-white p-8 w-full max-w-md rounded-xl shadow-2xl shadow-gray-200 border border-gray-100">
            ...
            <p class="text-center text-gray-500 mb-8 text-base">
                Daftar dan mulai kontribusi sekarang juga!
            </p>
            ...
            <form>
                ...
                <p class="mt-6 text-sm text-center text-gray-500">
                    Sudah punya akun?
                    <a href="/login" class="text-blue-600 hover:text-blue-800 hover:underline font-semibold transition">
                        Login di sini
                    </a>
                </p>
