    ...
    <header class="w-full bg-white/60 backdrop-blur-sm border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <span class="text-sm text-gray-500">Buat Artikel</span>
            </div>
                ...
                <div class="p-8">
                    <form id="create-form" class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="excerpt" id="excerpt" required rows="3" placeholder="Ringkasan artikel (max 500 karakter)"
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (data.errors) {
                        ...
                        errorDiv.textContent = data.message || 'Gagal membuat artikel';
                    }
                    errorDiv.classList.remove('hidden');
                }
            } catch (error) {
